...
type Makefile struct {
	...
	// TODO(asmacdo) This whole file needs an 's/ansible/python' audit
	// PythonOperatorVersion is the version of the ansible-operator binary downloaded by the Makefile.
	PythonOperatorVersion string
}
...
func (f *Makefile) SetTemplateDefaults() error {
	...
	if f.PythonOperatorVersion == "" {
		// TODO(asmacdo) Whatever this is idc right now.
		f.PythonOperatorVersion = "42000"
		// return errors.New("python-operator version is required in scaffold")
	}
